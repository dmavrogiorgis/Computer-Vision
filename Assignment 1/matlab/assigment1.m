...
cutoff_frequency = 10; %This is the standard deviation, in pixels, of the 
...
figure(3); imshow(vis);
imwrite(low_frequencies, 'output/low_frequencies.jpg', 'quality', 95);
imwrite(high_frequencies + 0.5, 'output/high_frequencies.jpg', 'quality', 95);
imwrite(hybrid_image, 'output/hybrid_image.jpg', 'quality', 95);
imwrite(vis, 'output/hybrid_image_scales.jpg', 'quality', 95);